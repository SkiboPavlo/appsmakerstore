...
class ExchangeRatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exchange_rate" do
    assert_difference('ExchangeRate.count') do
      post exchange_rates_url, params: { exchange_rate: { period: @exchange_rate.period, unit: @exchange_rate.unit } }
    end
  ...
  test "should update exchange_rate" do
    patch exchange_rate_url(@exchange_rate), params: { exchange_rate: { period: @exchange_rate.period, unit: @exchange_rate.unit } }
